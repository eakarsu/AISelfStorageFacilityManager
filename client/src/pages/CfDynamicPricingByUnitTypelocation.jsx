...
export default function CfDynamicPricingByUnitTypelocation() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-dynamic-pricing-by-unit-typelocation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>Dynamic pricing by unit type/location</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AISelfStorageFacilityManager - Custom feature</p>
