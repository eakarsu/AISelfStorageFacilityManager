...
const FEATURE_SLUG = 'no-securityalertanalysis-cameraalarm-summari';
const FEATURE_TITLE = 'No /security-alert-analysis (camera/alarm summarization)';
const PROJECT = 'AISelfStorageFacilityManager';
